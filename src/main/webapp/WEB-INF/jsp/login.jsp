...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/jquery.backstretch.js"></script>
    <!--[if lt IE 9]>
...
<script type="text/javascript">
    jQuery(document).ready(function() {
        ...
        */
        $.backstretch(["images/backgrounds/1.jpg", "images/backgrounds/2.jpg", "images/backgrounds/3.jpg"], {
            fade: 750,
            duration: 4000,
            speed: 500
        });
