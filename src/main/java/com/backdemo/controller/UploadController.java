...
public class UploadController {
    ...
    @ResponseBody
    public Map<String,Object> upload_submit(@RequestParam("file") MultipartFile file, HttpServletRequest request, User user) {
        ...
        //保存到数据库
        user.setAvatar(xdpath);
        userService.uploadImages(user);
